...
h3{
    ...
    <main>
        ...
        <!-- About Start -->
        <div class="container-xxl py-5" data-wow-delay="0.3s" data-aos="fade-in" data-aos-delay="200">
            <div class="container">
                    ...
                    <div class="col-lg-6">
                        <div class="row g-3">
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.1s" src="../www/css/aaa/img/about-1.jpg" style="margin-top: 25%;">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.3s" src="../www/css/aaa/img/about-2.jpg">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-50 wow zoomIn" data-wow-delay="0.5s" src="../www/css/aaa/img/about-3.jpg">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.7s" src="../www/css/aaa/img/about-4.jpg">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section>
         ...
         <!-- Contact Start -->
         <div class="container-xxl bg-white p-0" data-wow-delay="0.15s" data-aos="fade-in" data-aos-delay="200">
         <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
