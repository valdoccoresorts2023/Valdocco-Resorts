                    ...
                    <div class="owl-carousel owl-theme blog-post">
                        <div class="blog-content" data-aos="fade-right" data-aos-delay="200">
                            ...
                            <div class="blog-title">
                                <h3>Large pools and jacuzzis</h3>
                                <span>for you to enjoy</span>
                            </div>
                        </div>
                        <div class="blog-content" data-aos="fade-in" data-aos-delay="200">
                            ...
                            <div class="blog-title">
                                ...
                                <span>of all types</span>
                            </div>
                        </div>
                        <div class="blog-content" data-aos="fade-left" data-aos-delay="200">
                            <img src="./assets/Blog-post/imgjardin.jpg" alt="post-1" height="100" width="100">
                            <div class="blog-title">
                                <h3>Green areas to get fresh air</h3>
                                <span>and rejoice with nature</span>
                            </div>
                        </div>
                        <div class="blog-content" data-aos="fade-right" data-aos-delay="200">
                            <img src="./assets/Blog-post/imggym.jpg" alt="post-1" height="100" width="100">
                            <div class="blog-title">
                                <h3>A very well equipped and complete gym</h3>
                                <span>awaits you</span>
                            </div>
                        </div>
                        <div class="blog-content" data-aos="fade-right" data-aos-delay="200">
                            <img src="./assets/Blog-post/imgeventoEN.jpg" alt="post-1">
                            <div class="blog-title">
                                <h3>Our special events service </h3>
                                <span>for an unforgettable memory</span>
                            </div>
                        </div>
                        <div class="blog-content" data-aos="fade-right" data-aos-delay="200">
                            ...
                            <div class="blog-title">
                                ...
                                <span>to taste our exquisit gastronomy</span>
                            </div>
                        </div>
                        <div class="blog-content" data-aos="fade-right" data-aos-delay="200">
                            <img src="./assets/Blog-post/presii.jpg" alt="post-1">
                            <div class="blog-title">
                                <h3>We offer you a good room service</h3>
                                <span>we will be at your disposal all the time</span>
                            </div>
                        </div>
   ...
   <div class="row g-4">
       ...
       <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s" data-wow-delay="0.3s" data-aos="fade-left" data-aos-delay="200">
        ...
        <section class="container">
            ...
            <a href="./Nueva pagina de comodidades.php"><i class="fas fa-chevron-right"></i></a>
        </div>
                </div>
                <aside class="sidebar">
                    <div class="category">
